...
public class ActivityJczq extends Activity{
	Spinner spinner;
	...
	private void find_and_modify_view() {
		spinner = (Spinner) findViewById(R.id.jczq_spinner_1);
		...
		spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
			...
			public void showEntries(int guan){
				TextView tv = null;
				EditText et = null;
				tv = (TextView) findViewById(R.id.jczq_label8);
				et = (EditText) findViewById(R.id.jczq_entry8);
				if((guan+1)<8){
				...
				tv = (TextView) findViewById(R.id.jczq_label7);
				et = (EditText) findViewById(R.id.jczq_entry7);
				if((guan+1)<7){
					tv.setVisibility(View.INVISIBLE);
					et.setVisibility(View.INVISIBLE);
					et.setText("");
				...
				tv = (TextView) findViewById(R.id.jczq_label6);
				et = (EditText) findViewById(R.id.jczq_entry6);
				if((guan+1)<6){
					tv.setVisibility(View.INVISIBLE);
					et.setVisibility(View.INVISIBLE);
					et.setText("");
				...
				tv = (TextView) findViewById(R.id.jczq_label5);
				et = (EditText) findViewById(R.id.jczq_entry5);
				if((guan+1)<5){
					tv.setVisibility(View.INVISIBLE);
					et.setVisibility(View.INVISIBLE);
					et.setText("");
				...
				tv = (TextView) findViewById(R.id.jczq_label4);
				et = (EditText) findViewById(R.id.jczq_entry4);
				if((guan+1)<4){
					tv.setVisibility(View.INVISIBLE);
					et.setVisibility(View.INVISIBLE);
					et.setText("");
				...
				tv = (TextView) findViewById(R.id.jczq_label3);
				et = (EditText) findViewById(R.id.jczq_entry3);
				if((guan+1)<3){
					tv.setVisibility(View.INVISIBLE);
					et.setVisibility(View.INVISIBLE);
					et.setText("");
				...
				tv = (TextView) findViewById(R.id.jczq_label2);
				et = (EditText) findViewById(R.id.jczq_entry2);
				if((guan+1)<2){
					tv.setVisibility(View.INVISIBLE);
					et.setVisibility(View.INVISIBLE);
					et.setText("");
	...
	private Button.OnClickListener listener0 = new Button.OnClickListener(){
		...
		public void onClick(View v){
			EditText etext = null;
			etext = (EditText) findViewById(R.id.jczq_entry1);
			Editable oddsStr1 = etext.getText();
			etext = (EditText) findViewById(R.id.jczq_entry2);
			Editable oddsStr2 = etext.getText();
			etext = (EditText) findViewById(R.id.jczq_entry3);
			Editable oddsStr3 = etext.getText();
			etext = (EditText) findViewById(R.id.jczq_entry4);
			Editable oddsStr4 = etext.getText();
			etext = (EditText) findViewById(R.id.jczq_entry5);
			Editable oddsStr5 = etext.getText();
			etext = (EditText) findViewById(R.id.jczq_entry6);
			Editable oddsStr6 = etext.getText();
			etext = (EditText) findViewById(R.id.jczq_entry7);
			Editable oddsStr7 = etext.getText();
			etext = (EditText) findViewById(R.id.jczq_entry8);
			Editable oddsStr8 = etext.getText();
			
			etext = (EditText) findViewById(R.id.jczq_entry_multi);
